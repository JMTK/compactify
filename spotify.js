function Spotify($http, $q) {
    'use strict';
    return {
        getFollowedArtists: function(accessToken) {
            return $http({
                method: 'GET',
        ...
        searchForTrack: function(searchText, accessToken) {
            return $http({
                method: 'GET',
        ...
        getAlbumsForArtist: function(artistID, accessToken) {
            return $http({
                method: 'GET',
        ...
        getPlaylistTracks: function(playlistURL, snapshotID, accessToken) {
        ...
        getAudioFeaturesForTracks: function(tracksList, accessToken) {
        ...
        getUserPlaylistData: function (accessToken, userid) {
            return $http({
                method: 'GET',
        ...
        addTracksToCompactPlaylist: function (playlistURL, tracksList, accessToken) {
            return $http({
        ...
        createCompactPlaylist: function (playlistName, accessToken, userid, name) {
            return $http({
